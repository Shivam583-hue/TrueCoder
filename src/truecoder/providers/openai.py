...
from truecoder.providers.models import DEFAULT_PROVIDER_NAME, Provider
...
def default_openai_provider() -> Provider:
    return openai_provider(name=DEFAULT_PROVIDER_NAME)
